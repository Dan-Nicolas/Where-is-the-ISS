// code for making a map and tiles. tiles are the pieces of the map put together to create the image 
...
// this code changes the marker on the map to my preferred image. a png image
const map_icon = L.icon({
    iconUrl: 'icon.png',
    iconSize: [50, 32],
    iconAnchor: [25, 16],
});
//this code places a marker on the map at my preferred latitude and longitude. the longitude and latitude is modified after my async function runs.
const marker = L.marker([0, 0], {icon: map_icon}).addTo(map);

// this function gets information from two apis. iss locating and a weather api
async function retrieveData(){
    //getting information from ISS api and storing the latitude and longitude in variables
    ...
    document.getElementById('speed').textContent = speed
     ...
     //displaying the weather at the current location of the iss by using the variables from above
